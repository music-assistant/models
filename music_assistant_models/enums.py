...
class PlayerOptionTranslationKey(StrEnum):
    """Common translation keys for a PlayerOption.

    These keys are used in the Music Assistant frontend AND in the Home Assistant
    integration. If you add a key, remember to update the client, bump the client
    in Home Assistant, and finally add the respective keys to the Home Assistant
    integration.

    The keys for both integrations are members of the player_options group, i.e.:
    "player_options": {
        "adaptive_drc": "Adaptive dynamic range compression",
        ...
    }
    """

    ADAPTIVE_DRC = "adaptive_drc"
    DIALOGUE_LEVEL = "dialogue_level"
    DIALOGUE_LIFT = "dialogue_lift"
    DTS_DIALOGUE_CONTROL = "dts_dialogue_control"
    ENHANCER = "enhancer"
    EQUALIZER_HIGH = "equalizer_high"
    EQUALIZER_MID = "equalizer_mid"
    EQUALIZER_LOW = "equalizer_low"
    EXTRA_BASS = "extra_bass"
    LINK_AUDIO_DELAY = "link_audio_delay"
    LINK_AUDIO_DELAY_LIP_SYNC = "link_audio_delay_lip_sync"
    LINK_AUDIO_DELAY_BALANCED = "link_audio_delay_balanced"
    LINK_AUDIO_DELAY_AUDIO_SYNC = "link_audio_delay_audio_sync"
    LINK_AUDIO_DELAY_AUDIO_SYNC_ON = "link_audio_delay_audio_sync_on"
    LINK_AUDIO_DELAY_AUDIO_SYNC_OFF = "link_audio_delay_audio_sync_off"
    LINK_CONTROL = "link_control"
    LINK_CONTROL_STANDARD = "link_control_standard"
    LINK_CONTROL_SPEED = "link_control_speed"
    LINK_CONTROL_STABILITY = "link_control_stability"
    PURE_DIRECT = "pure_direct"
    SLEEP_TIMER = "sleep_timer"
    SLEEP_TIMER_OFF = "sleep_timer_off"
    SURROUND_DECODER_DEVICE = "surround_decoder_device"
    SUBWOOFER_VOLUME = "subwoofer_volume"
    TONE_CONTROL_MODE = "tone_control_mode"
    TONE_CONTROL_BASS = "tone_control_bass"
    TONE_CONTROL_TREBLE = "tone_control_treble"
